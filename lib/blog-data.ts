...
export const blogPosts: BlogPost[] = [
  {
    ...
    resume:
      "jamaisplusedouard.fr est ne d'un constat : les medias mainstream ne font pas leur travail d'investigation sur Édouard Philippe. Ce site comble ce vide.",
    contenu: `La démocratie française traverse une crise de confiance sans précédent. Les citoyens ne croient plus en la capacite des medias a informer de manière indépendante. Et pour cause.

Quand BFM TV, premier media d'information en continu, appartient a CMA CGM — le premier armateur opérant dans le port du candidat qu'elle couvre —, le conflit d'intérêts est structurel. Quand le rédacteur en chef des Échos (David Barroux) est issu de la même promotion Young Leaders que le candidat qu'il couvre (Edouard Philippe, promotion 2011), l'independance éditoriale est une fiction. Quand la présidente de Radio France (Sibyle Veil) est camarade de promotion ENA du président qui a nomme ce candidat Premier ministre, le service public d'information est capture.

Ce site existe pour faire ce que les medias ne font pas : documenter, sourcer, relier les points.

Nous ne sommes pas neutres. Nous sommes un site d'opposition politique, et nous l'assumons. La Constitution francaise garantit ce droit. L'article 11 de la Déclaration des Droits de l'Homme protege la libre communication des pensees et des opinions. La loi du 29 juillet 1881 sur la liberte de la presse encadre notre travail.

Ce qui nous distingue : chaque fait est source. Chaque lien est documente. Chaque chaine de conflits d'intérêts est tracee maillon par maillon. Nous utilisons l'intelligence artificielle — des agents de veille automatises 24/7 — pour surveiller ce qu'un citoyen seul ne pourrait pas couvrir.
