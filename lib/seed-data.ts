...
export const reseau: PersonneReseau[] = [
  ...
  },
  {
    ...
    description:
      "Vincent Bolloré est un industriel breton qui a construit un empire médiatique via Vivendi : Canal+, CNews, C8, Europe 1, Paris Match. Son rachat progressif de ces médias à partir de 2015 a été accompagné d'une réorientation éditoriale vers la droite et l'extrême droite, avec des figures comme Éric Zemmour, Pascal Praud et Laurence Ferrari. CNews est devenue la « Fox News française » — plateforme de l'émergence de Zemmour en 2021-2022 et sanctionnée par l'Arcom pour manquements au pluralisme. Correction (bulletin 2 avril 2026) : CNews et Europe 1 ne sont PAS des médias macronistes. Bolloré est structurellement adversaire du macronisme. Sa reprise occasionnelle du narratif « Philippe rempart face au RN » ne constitue pas un soutien, mais la convergence circonstancielle d'un adversaire commun (le RN). Les ministères de l'Intérieur et des Armées n'entretiennent pas de relations de soutien avec CNews. Bolloré a également des intérêts en Afrique (Bolloré Africa Logistics) revendus à CMA CGM en 2022 — lien direct avec le groupe Saadé. La cartographie médiatique correcte distingue : Arnault (Les Échos, Le Parisien) et Saadé/CMA CGM (BFM TV) = sphère favorable à Philippe ; Bolloré (CNews, Europe 1) = sphère adverse (droite dure/conservatrice).",
    typeLien: "mediatique",
    sousReseaux: ["entreprises"],
  },
  {
