...
export const reseau: PersonneReseau[] = [
  ...
  },
  {
    ...
    description:
      "Vincent Bollore est un industriel breton qui à construit un empire médiatique via Vivendi : Canal+, CNews, C8, Europe 1, Paris Match, Le Journal du Dimanche. Son rachat progressif de ces médias à partir de 2015 à été accompagne d'une réorientation éditoriale vers la droite et l'extrême-droite, avec des figures comme Eric Zemmour, Pascal Praud et Laurence Ferrari. CNews est devenue la « Fox News française ». Dans le jeu politique, Bollore est un « faiseur de rois » : sa chaîne à permis l'émergence médiatique de Zemmour comme candidat présidentiel en 2022. Pour Philippe, CNews joue un rôle paradoxal : la chaîne le présenté comme l'alternative « raisonnable » face au RN, servant le récit macroniste du barrage républicain. Europe 1, sous contrôle Bollore via Lagardere, à été réorientée vers une ligne compatible avec le centre-droit de Philippe. Bollore à également des intérêts massifs en Afrique (Bollore Africa Logistics, ports) et en Asie, ce qui le connecte aux enjeux de transport maritime et aux réseaux sino-africains. Son empire logistique africain à été revendu à CMA CGM (MSC) en 2022, creant un lien direct entre Bollore et le groupe Saade. La concentration médiatique entre Arnault (Les Échos, Le Parisien), Bollore (CNews, Europe 1) et Saade/CMA CGM (BFM TV) signifie que les trois premiers médias d'info de France sont detenus par des oligarques proches du pouvoir macroniste.",
    typeLien: "mediatique",
    sousReseaux: ["entreprises"],
  },
  {
