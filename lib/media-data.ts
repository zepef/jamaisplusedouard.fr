...
export const chainesMedia: ChaineMedia[] = [
  ...
  // Titres du ledger PasEdouard absents de la liste fermée (août 2026)
  {
    nom: "L'Express",
    slug: "l-express",
    categorie: "independant",
    description: "Hebdomadaire d'actualité libéral, doyen des newsmagazines français. Couverture politique nationale, enquêtes et interviews. Identifié par le ledger PasEdouard comme source d'apparitions Philippe.",
    proprietaire: "Groupe L'Express — Alain Weill (Nextnow), 100 % depuis septembre 2023 (rachat des 49 % Drahi/Altice)",
    lienMacronisme: "Pas de lien capitalistique macroniste actuel. Weill a fondé et dirigé NextRadioTV (BFM, RMC) avant les cessions à Altice puis CMA CGM. Hebdomadaire libéral, sans alignement structurel documenté sur Philippe.",
  },
  {
    nom: "TF1 Info",
    slug: "tf1-info",
    categorie: "macroniste",
    description: "Marque d'information du groupe TF1 (site et offre info). Relais numérique des journaux et de LCI. Identifiée par le ledger PasEdouard.",
    proprietaire: "Bouygues (Groupe TF1)",
    lienMacronisme: "Même groupe que LCI. Martin Bouygues est un proche historique de Nicolas Sarkozy. TF1/LCI/TF1 Info : positionnement centre-droit compatible avec Philippe, invitations fréquentes des figures Horizons.",
  },
  {
    nom: "Public Sénat",
    slug: "public-senat",
    categorie: "public",
    description: "Chaîne parlementaire du Sénat. Débats, magazines politiques, baromètres Odoxa Public Sénat. Identifiée par le ledger PasEdouard.",
    proprietaire: "Sénat de la République (État)",
    lienMacronisme: "Audiovisuel parlementaire : gouvernance du Sénat, pas de l'exécutif. Pas d'alignement capitalistique. Les baromètres Odoxa Public Sénat sont une source de mesure politique, pas un relais de campagne.",
  },
  {
    nom: "RMC",
    slug: "rmc",
    categorie: "macroniste",
    description: "Radio généraliste et marque info (RMC, RMC Story) du pôle ex-Altice Media. Matinale et débats politiques à large audience. Identifiée par le ledger PasEdouard.",
    proprietaire: "CMA CGM / Rodolphe Saadé (rachat d'Altice Media à Patrick Drahi finalisé en 2024)",
    lienMacronisme: "Même propriétaire que BFM TV et La Tribune. Le responsable sécurité de CMA CGM (Yann Le Goff) est Young Leader 2011 avec Philippe. Convergence CMA CGM / médias / réseau Philippe : conflit d'intérêts médiatique identique à celui de BFM.",
  },
  {
    nom: "Paris-Normandie",
    slug: "paris-normandie",
    categorie: "independant",
    description: "Quotidien régional de l'ex-Haute-Normandie (Rouen, Le Havre). Couverture du territoire dont Philippe est maire. Identifié par le ledger PasEdouard.",
    proprietaire: "Groupe Rossel (belge) — Rossel France / La Voix, depuis juin 2020",
    lienMacronisme: "Aucun lien capitalistique macroniste : groupe de presse belge familial, comme 20 Minutes et La Voix du Nord. Quotidien du territoire de Philippe ; couverture locale à qualifier au cas par cas.",
  },
  {
    nom: "Libération",
    slug: "liberation",
    categorie: "independant",
    description: "Quotidien national de gauche, fondé en 1973. Enquêtes et couverture politique. Identifié par le ledger PasEdouard (et déjà listé dans les flux RSS Matraquage).",
    proprietaire: "Fonds de dotation pour une presse indépendante (FDPI), via Presse indépendante — créé en 2020 à l'initiative d'Altice/Drahi",
    lienMacronisme: "Pas de lien capitalistique macroniste. Indépendance formelle via fonds de dotation ; dépendance financière documentée envers Daniel Křetínský (prêts, ordre de grandeur ~60 M€ depuis 2022) — Křetínský n'est pas l'actionnaire. Couverture généralement critique du macronisme.",
  },
  {
    nom: "RFI",
    slug: "rfi",
    categorie: "public",
    description: "Radio France Internationale. Audiovisuel extérieur, actualité française et internationale. Identifiée par le ledger PasEdouard.",
    proprietaire: "France Médias Monde (État)",
    lienMacronisme: "Audiovisuel extérieur public. Nomination de la présidence dans le périmètre de l'exécutif / Arcom. Relais international de l'actualité française, y compris les figures gouvernementales et ex-gouvernementales.",
  },
  {
    nom: "LCP",
    slug: "lcp",
    categorie: "public",
    description: "La Chaîne Parlementaire — Assemblée nationale. Séances, magazines et débats politiques. Identifiée par le ledger PasEdouard.",
    proprietaire: "Assemblée nationale (État)",
    lienMacronisme: "Audiovisuel parlementaire : gouvernance de l'Assemblée, pas d'alignement capitalistique.",
  },
  {
    nom: "France Culture",
    slug: "france-culture",
    categorie: "public",
    description: "Radio publique de débat, d'idées et de magazines. Interviews et émissions politiques. Identifiée par le ledger PasEdouard.",
    proprietaire: "Radio France (État)",
    lienMacronisme: "Même gouvernance que France Inter. Sibyle Veil, présidente de Radio France depuis 2018, est une camarade de promotion ENA de Macron (promotion Léopold Sédar Senghor, 2004).",
  },
  {
    nom: "France 3",
    slug: "france-3",
    categorie: "public",
    description: "Chaîne publique généraliste et réseau régional (dont France 3 Normandie). Journaux nationaux et éditions locales. Identifiée par le ledger PasEdouard.",
    proprietaire: "France Télévisions (État)",
    lienMacronisme: "Même gouvernance que France 2. Delphine Ernotte reconduite par l'Arcom en 2025. Le réseau régional couvre le Havre et le territoire de Philippe.",
  },
  {
    nom: "HuffPost",
    slug: "huffpost",
    categorie: "independant",
    description: "Pure player d'actualité (édition française). Couverture politique grand public. Identifié par le ledger PasEdouard.",
    proprietaire: "Groupe Le Monde (85 %) — même actionnariat de référence que Le Monde / Le Nouvel Obs (Xavier Niel, Daniel Křetínský, Matthieu Pigasse / structures associées)",
    lienMacronisme: "Même actionnariat que Le Monde : l'actionnaire de référence Xavier Niel est un proche de Macron, mais les rédactions sont distinctes. Pas d'alignement éditorial documenté sur Philippe.",
  },
  {
    nom: "Le Journal du Dimanche",
    slug: "le-jdd",
    categorie: "opposition",
    description: "Hebdomadaire du dimanche. Ligne droitière assumée depuis la prise de contrôle Bolloré (2023). Identifié par le ledger PasEdouard.",
    proprietaire: "Lagardère / Louis Hachette Group — Vincent Bolloré (prise de contrôle de Lagardère et scission de Vivendi, 2023-2024)",
    lienMacronisme: "Adversaire structurel : même pôle Bolloré que CNews et Europe 1. Non aligné avec le centre-libéral macroniste ni avec Philippe.",
  },
  {
    nom: "Marianne",
    slug: "marianne",
    categorie: "independant",
    description: "Hebdomadaire d'actualité. Ligne historiquement souverainiste, laïque et antilibérale. Identifié par le ledger PasEdouard.",
    proprietaire: "CMI France — Daniel Křetínský (Czech Media Invest)",
    lienMacronisme: "Propriété de Křetínský (aussi présent au capital historique du Monde et prêteur documenté de Libération). Pas d'alignement structurel sur Philippe. Tentatives de cession 2024-2025 non abouties au moment de la rédaction de cette fiche.",
  },
  {
    nom: "L'Humanité",
    slug: "l-humanite",
    categorie: "opposition",
    description: "Quotidien de gauche fondé par Jaurès (1904). N'est plus l'organe officiel du PCF. Identifié par le ledger PasEdouard.",
    proprietaire: "Société nouvelle du journal L'Humanité (SNJH) — lecteurs, personnels, amis, diffuseurs et actionnaires individuels ; direction Fabien Gay",
    lienMacronisme: "Aucun. Critique systématique du macronisme et de ses alliés. Capital réparti entre sociétés de lecteurs/personnels/amis et actionnaires individuels (souvent issus de l'écosystème PCF) — cap table 2026 non re-vérifiée ligne à ligne.",
  },
  {
    nom: "La Croix",
    slug: "la-croix",
    categorie: "independant",
    description: "Quotidien d'information généraliste d'inspiration catholique. Couverture politique et société. Identifié par le ledger PasEdouard.",
    proprietaire: "Groupe Bayard — congrégation des Augustins de l'Assomption",
    lienMacronisme: "Aucun lien capitalistique macroniste. Propriété d'une congrégation religieuse. Ligne centriste/humaniste, sans alignement documenté sur Philippe.",
  },
  {
    nom: "La Voix du Nord",
    slug: "la-voix-du-nord",
    categorie: "independant",
    description: "Grand quotidien régional du Nord. Identifié par le ledger PasEdouard.",
    proprietaire: "Groupe Rossel (belge) — Rossel France",
    lienMacronisme: "Aucun lien avec la Macronie : même groupe belge que 20 Minutes et Paris-Normandie. Couverture régionale factuelle.",
  },
  {
    nom: "L'Indépendant",
    slug: "l-independant",
    categorie: "independant",
    description: "Quotidien régional (Pyrénées-Orientales / Aude). Identifié par le ledger PasEdouard.",
    proprietaire: "Groupe La Dépêche — famille Baylet (Jean-Michel Baylet, PRG)",
    lienMacronisme: "Pas de lien capitalistique macroniste : même groupe que La Dépêche du Midi. Couverture régionale, sans alignement documenté sur Philippe.",
  },
];
