...
export const chainesMedia: ChaineMedia[] = [
  ...
  },
  {
    ...
    lienMacronisme: "Bolloré a réorienté CNews vers la droite conservatrice. La chaîne donne une visibilité importante a Philippe comme alternative « raisonnable » face au RN, servant le récit macroniste du « barrage républicain ».",
  },
  {
    nom: "Europe 1",
    slug: "europe-1",
    categorie: "macroniste",
    description: "Radio généraliste historique. Matinale politique, interviews du matin.",
    proprietaire: "Vivendi / Lagardère (Vincent Bolloré)",
    lienMacronisme: "Passee sous contrôle Bolloré via Lagardère. La ligne éditoriale a été réorientée vers le centre-droit, favorable aux figures comme Philippe.",
  },
  {
    nom: "Le Point",
    slug: "le-point",
  ...
  // Medias indépendants
  {
    ...
    description: "Media d'investigation en ligne. Fondé par Edwy Plenel. Enquêtes sur les conflits d'intérêts et le réseau Philippe.",
  ...
  },
  {
    ...
    slug: "blast",
    categorie: "independant",
    description: "Media d'investigation vidéo en ligne. A enquêté sur les liens Philippe-Atos et les conflits d'intérêts.",
